        ...
        <div className="fixed inset-0 z-50 flex animate-in fade-in duration-200">
          ...
          <div className="relative w-5/6 max-w-xs h-full bg-white dark:bg-slate-900 shadow-2xl flex flex-col justify-between border-r border-slate-200 dark:border-slate-800 z-10 animate-in slide-in-from-left duration-250">
            ...
            <div className="p-5 flex flex-col h-full overflow-hidden">
              ...
              {/* Telegram Channel & Admin Panel in Drawer */}
              <div className="pt-4 border-t border-slate-100 dark:border-slate-800 shrink-0 space-y-2">
                <a
                  href={telegramUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-2xl bg-[#24A1DE] hover:bg-[#1d93ce] text-white font-bold text-xs sm:text-sm shadow-md shadow-[#24A1DE]/25 active:scale-98 transition-all"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2 rounded-2xl bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs transition-colors"
                >
